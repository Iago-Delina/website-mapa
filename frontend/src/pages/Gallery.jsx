  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0b] via-[#0f1011] to-[#0a0a0b]">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://customer-assets.emergentagent.com/job_tibiaworld/artifacts/go9pbhnn_image.png')] bg-cover bg-center opacity-10" />
