...
import { createMap, uploadImage } from '../services/apiService';
...
const AdminMapForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Erro ao criar mapa: ' + (error.response?.data?.detail || error.message));
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0b] via-[#0f1011] to-[#0a0a0b] pt-24 pb-20">
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
        ...
        <Card className="bg-gray-900/50 border-emerald-500/20 p-8">
          <h1 className="text-3xl font-bold text-white mb-8">Criar Novo Mapa</h1>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-emerald-500/20 rounded-lg p-6 text-center">
                ...
                <label htmlFor="image-upload" className="cursor-pointer">
                  ...
                  <p className="text-gray-400">Clique para fazer upload de imagens</p>
                </label>
              </div>
